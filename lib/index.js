...
module.exports = function(options) {
    ...
    return function(files, metalsmith, done) {
        ...
        handlebars.registerHelper('bibsort', function(collection, sortField, reverseOrder = false, opt) {
            if (opt === undefined) {
        ...
        // field values
        handlebars.registerHelper('bibgroup', function(collection, groupField, reverseOrder = false, opt) {
            if (opt === undefined) {
                if (reverseOrder === undefined) {
 ...
 */
function sortBibCollection(collection, sortField, reverseOrder = false) {
 ...
 */
function groupBibCollection(collection, groupField, reverseOrder = false) {
    const bibkeys = Object.keys(collection);
